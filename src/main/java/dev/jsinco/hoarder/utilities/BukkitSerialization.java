...
/**
 * Serialization for itemStacks and Inventories.
 * Credit: <a href="https://gist.github.com/graywolf336/8153678">Github Gist</a>
 */
public class BukkitSerialization {
    ...
    public static ItemStack itemStackFromBase64(String data) {
        try {
            ...
            dataInput.readInt(); // Ignore
            ItemStack item = (ItemStack) dataInput.readObject();

            dataInput.close();
            return item;
        } catch (ClassNotFoundException | IOException e) {
            plugin.getLogger().log(Level.SEVERE, "Unable to decode class type.", e);
        }
        return null;
    }
}
